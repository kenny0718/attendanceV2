...
class TestEntitlementsAPI:
    ...
    def test_super_admin_can_list_any_company_entitlements(self, db_session):
    ...
    def test_customer_service_can_list_assigned_company_entitlements(self, db_session):
    ...
    def test_customer_service_cannot_list_unassigned_company_entitlements(self, db_session):
    ...
    def test_company_user_can_list_own_company_entitlements(self, db_session):
    ...
    def test_super_admin_can_update_entitlement(self, db_session):
    ...
    def test_customer_service_cannot_update_entitlement(self, db_session):
    ...
    def test_update_entitlement_validates_feature_key(self, db_session):
    ...
    def test_super_admin_can_apply_plan_defaults(self, db_session):
    ...
    def test_update_entitlement_clears_cache(self, db_session):
