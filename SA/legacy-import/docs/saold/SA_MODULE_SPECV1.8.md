...
4A️⃣ Platform Roles & Company Scope（P0）
4A.1 Platform Roles
super_admin
...
3️⃣ Feature Gate（若適用）

此順序不可顛倒。

5️⃣ Tenant Isolation（P0）
寫入規則
...
12A️⃣ Company Entitlements / Feature Flags（P0）
